...
\hypertarget{md_googletest_2docs_2primer_autotoc_md227}{}\doxysection{\texorpdfstring{Introduction\+: Why Google\+Test?}{Introduction\+: Why Google\+Test?}}\label{md_googletest_2docs_2primer_autotoc_md227}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a1a6db8b1338ee7040329322b77779086}{ASSERT\_EQ}}(\mbox{\hyperlink{gmock-matchers-containers__test_8cc_a6150e0515f7202e2fb518f7206ed97dc}{x}}.size(),\ \mbox{\hyperlink{gmock-matchers-containers__test_8cc_a39cb44155237f0205e0feb931d5acbed}{y}}.size())\ <<\ \textcolor{stringliteral}{"{}Vectors\ x\ and\ y\ are\ of\ unequal\ length"{}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ \mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}}\ =\ 0;\ \mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}}\ <\ \mbox{\hyperlink{gmock-matchers-containers__test_8cc_a6150e0515f7202e2fb518f7206ed97dc}{x}}.size();\ ++\mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}})\ \{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{gmock-matchers-containers__test_8cc_a6150e0515f7202e2fb518f7206ed97dc}{x}}[\mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}}],\ \mbox{\hyperlink{gmock-matchers-containers__test_8cc_a39cb44155237f0205e0feb931d5acbed}{y}}[\mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}}])\ <<\ \textcolor{stringliteral}{"{}Vectors\ x\ and\ y\ differ\ at\ index\ "{}}\ <<\ \mbox{\hyperlink{gmock-matchers-comparisons__test_8cc_acb559820d9ca11295b4500f179ef6392}{i}};}
\DoxyCodeLine{\}}
...
\begin{DoxyEnumerate}
\item Use the {\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}} macro to define and name a test function. These are ordinary C++ functions that don\textquotesingle{}t return a value.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST}}(TestSuiteName,\ TestName)\ \{}
...
{\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}} arguments go from general to specific. The {\itshape first} argument is the name of the test suite, and the {\itshape second} argument is the test\textquotesingle{}s name within the test suite. Both names must be valid C++ identifiers, and they should not contain any underscores ({\ttfamily \+\_\+}). A test\textquotesingle{}s {\itshape full name} consists of its containing test suite and its individual name. Tests from different test suites can have the same individual name.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(\textcolor{keywordtype}{int}\ n);\ \ \textcolor{comment}{//\ Returns\ the\ factorial\ of\ n}}
...
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST}}(FactorialTest,\ HandlesZeroInput)\ \{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(0),\ 1);}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Tests\ factorial\ of\ positive\ numbers.}}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST}}(FactorialTest,\ HandlesPositiveInput)\ \{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(1),\ 1);}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(2),\ 2);}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(3),\ 6);}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(\mbox{\hyperlink{sample1_8cc_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(8),\ 40320);}
\DoxyCodeLine{\}}

\end{DoxyCode}


Google\+Test groups the test results by test suites, so logically related tests should be in the same test suite; in other words, the first argument to their {\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}} should be the same. In the above example, we have two tests, {\ttfamily Handles\+Zero\+Input} and {\ttfamily Handles\+Positive\+Input}, that belong to the same test suite {\ttfamily Factorial\+Test}.
...
When using a fixture, use {\ttfamily \doxylink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}} instead of {\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}} as it allows you to access objects and subroutines in the test fixture\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(TestFixtureClassName,\ TestName)\ \{}
\DoxyCodeLine{\ \ ...\ test\ body\ ...}
\DoxyCodeLine{\}}
...
Unlike {\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}}, in {\ttfamily \doxylink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}} the first argument must be the name of the test fixture class. ({\ttfamily \+\_\+F} stands for "{}\+Fixture"{}). No test suite name is specified for this macro.
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{class_queue_ab09891e54b51dc677ee6efb350687ae4}{Queue}}();}
\DoxyCodeLine{\ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_queue_abaa2e7175457307bca74f5562cbdaaa9}{Enqueue}}(\textcolor{keyword}{const}\ E\&\ element);}
\DoxyCodeLine{\ \ E*\ \mbox{\hyperlink{class_queue_a42bb3a81cb3f6cd084da16a39d38eb03}{Dequeue}}();\ \ \textcolor{comment}{//\ Returns\ NULL\ if\ the\ queue\ is\ empty.}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(QueueTest,\ IsEmptyInitially)\ \{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(q0\_.size(),\ 0);}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(QueueTest,\ DequeueWorks)\ \{}
\DoxyCodeLine{\ \ \textcolor{keywordtype}{int}*\ n\ =\ q0\_.Dequeue();}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(n,\ \textcolor{keyword}{nullptr});}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ n\ =\ q1\_.Dequeue();}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_aa866c8dece57912e6f51495ed3e8d8d5}{ASSERT\_NE}}(n,\ \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(*n,\ 1);}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(q1\_.size(),\ 0);}
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(q2\_.size(),\ 1);}
\DoxyCodeLine{\ \ \textcolor{keyword}{delete}\ n;}
\DoxyCodeLine{\}}
...
{\ttfamily \doxylink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}} and {\ttfamily \doxylink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}} implicitly register their tests with Google\+Test. So, unlike with many other C++ testing frameworks, you don\textquotesingle{}t have to re-\/list all your defined tests in order to run them.
...
IMPORTANT\+: You must {\bfseries{not}} ignore the return value of {\ttfamily \doxylink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}, or you will get a compiler error. The rationale for this design is that the automated testing service determines whether a test has passed based on its exit code, not on its stdout/stderr output; thus your {\ttfamily \doxylink{googletest-uninitialized-test___8cc_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}} function must return the value of {\ttfamily \doxylink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}.

Also, you should call {\ttfamily \doxylink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}} only {\bfseries{once}}. Calling it more than once conflicts with some advanced Google\+Test features (e.\+g., thread-\/safe \href{advanced.md\#death-tests}{\texttt{ death tests}}) and thus is not supported. \end{quote}
...
If you write your own {\ttfamily main} function, it should return the value of {\ttfamily \doxylink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}.
...
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(FooTest,\ MethodBarDoesAbc)\ \{}
...
\DoxyCodeLine{\ \ Foo\ f;}
\DoxyCodeLine{\ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(f.Bar(input\_filepath,\ output\_filepath),\ 0);}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Tests\ that\ Foo\ does\ Xyz.}}
\DoxyCodeLine{\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(FooTest,\ DoesXyz)\ \{}
...
The {\ttfamily \doxylink{namespacetesting_ace27eb9a2534996f3711aa719689f987}{testing\+::\+Init\+Google\+Test()}} function parses the command line for Google\+Test flags, and removes all recognized flags. This allows the user to control a test program\textquotesingle{}s behavior via various flags, which we\textquotesingle{}ll cover in the \doxysectlink{md_googletest_2docs_2advanced}{Advanced\+Guide}{0}. You {\bfseries{must}} call this function before calling {\ttfamily \doxylink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}, or the flags won\textquotesingle{}t be properly initialized.
...
But maybe you think that writing all those {\ttfamily main} functions is too much work? We agree with you completely, and that\textquotesingle{}s why Google Test provides a basic implementation of \doxylink{googletest-uninitialized-test___8cc_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}. If it fits your needs, then just link your test with the {\ttfamily gtest\+\_\+main} library and you are good to go.
